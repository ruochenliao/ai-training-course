  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 24 }}>
        ...
        >
          <Paragraph>基于企业知识库的智能问答系统，支持多智能体协作，提供准确、专业的回答。</Paragraph>
        </Card>
        ...
        <Card
          ...
          style={{ cursor: 'pointer' }}
        >
          <Paragraph>创建和管理企业知识库，支持多种文档格式，智能分析和向量化处理。</Paragraph>
        </Card>
        ...
        <Card
          ...
          style={{ cursor: 'pointer' }}
        >
          <Paragraph>测试系统各项功能，验证前后端连接状态，确保系统正常运行。</Paragraph>
        </Card>
      </div>
    </div>
  )
