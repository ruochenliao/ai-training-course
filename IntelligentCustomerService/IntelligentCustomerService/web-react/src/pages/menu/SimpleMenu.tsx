...
const SimpleMenu: React.FC = () => {
  ...
  return (
    <div className="p-6">
      <Title level={2} className="mb-6">一级菜单示例</Title>
      
      <Paragraph className="mb-6">
        这是一个简单的一级菜单页面示例，展示了基本的菜单布局和功能。您可以根据实际需求进行扩展和定制。
      </Paragraph>
      ...
      <Card className="mt-8">
        ...
        <Paragraph>
          一级菜单通常用于展示系统的主要功能模块，提供清晰的导航入口。
          在实际应用中，可以根据业务需求自定义菜单项的内容和样式。
        </Paragraph>
        
        <Title level={4} className="mt-4">配置方法</Title>
        <List
          bordered
          className="mt-2"
          dataSource={[
