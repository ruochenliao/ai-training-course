...
import {type CreateUserParams, type UpdateUserParams, type User, userApi, type UserQueryParams} from '@/api/user.ts'
import {type Role, roleApi} from '@/api/role.ts'
import {type Dept, deptApi} from '@/api/dept.ts'
