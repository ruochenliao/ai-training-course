...
async def main():
    ...
    # my_agent 订阅 TOPIC1
    await runtime.add_subscription(TypeSubscription(topic_type=TOPIC1, agent_type="my_agent"))
    await runtime.add_subscription(TypeSubscription(topic_type=TOPIC2, agent_type="my_agent"))
    await runtime.add_subscription(TypeSubscription(topic_type=TOPIC2, agent_type="my_agent2"))
    await runtime.add_subscription(TypeSubscription(topic_type=TOPIC2, agent_type="my_agent3"))
    ...
    # 广播发消息
    await runtime.publish_message(MyMessageType("Hello, World!"), topic_id=TopicId(type=TOPIC2, source="default"))
    # await runtime.publish_message(MyMessageType("Hello, World!"), topic_id=DefaultTopicId(type=TOPIC2))
